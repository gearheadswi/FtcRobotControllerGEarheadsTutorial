...
@Autonomous(name = "TipFirst", group = "Autonomous")
public class TipFirst extends OpMode {
    ...
    private Path toPark = Paths.curve(ShootFacing, ShootFacingControl, ParkingPose);
